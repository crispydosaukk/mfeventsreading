...
const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-black/70 border-b border-white/10 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-6 py-3.5 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-7 text-sm font-medium">
          ...
          <a
            href="#book"
            className="text-white font-semibold px-5 py-2.5 rounded-xl transition-all shadow-lg hover:shadow-amber-500/20 hover:scale-[1.02] active:scale-[0.98] flex items-center gap-2"
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="md:hidden backdrop-blur-2xl bg-black/90 border-t border-white/10 px-6 py-5 flex flex-col gap-4 shadow-2xl animate-in fade-in slide-in-from-top-2 duration-200">
          <a href="#services" className="text-gray-200 hover:text-amber-400 text-sm font-medium py-1" onClick={() => setMenuOpen(false)}>Services</a>
