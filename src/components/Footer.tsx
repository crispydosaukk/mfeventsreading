      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="#services" className="hover:text-amber-400 transition-colors">Catering Services</a></li>
            <li><a href="#menus" className="hover:text-amber-400 transition-colors">Banquet Packages</a></li>
        ...
        <div className="space-y-3">
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="mailto:catering@madrasflavours.co.uk" className="hover:text-amber-400 transition-colors flex items-center gap-2"><Icon name="EnvelopeIcon" size={14} /> catering@madrasflavours.co.uk</a></li>
            <li><a href="tel:+442039251743" className="hover:text-amber-400 transition-colors flex items-center gap-2"><Icon name="PhoneIcon" size={14} /> +44 20 3925 1743</a></li>
